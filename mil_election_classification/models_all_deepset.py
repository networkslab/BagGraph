...
class DeepSet(nn.Module):
    ...
    def __init__(self, in_features=10, set_features=128, nhid=64, dropout=0.5):
        ...
        self.feature_extractor = nn.Sequential(
            nn.Linear(in_features, set_features),
            nn.ReLU(),
            nn.Linear(set_features, set_features),
            nn.ReLU()
        )

        self.regressor = nn.Sequential(
            nn.Linear(set_features, nhid),
            nn.ReLU()
        )
        self.reset_parameters()
