...
def run_set_transformer_one_dataset(blank, data_index, r=5):
    datasets = ['fox', 'tiger', 'elephant']
    ...
    log_dir = 'log_st_r_' + str(r) + '/' + data_name
    ...
    def get_performance_test(trial_i, fold_j):
        ...
        models = [
            SetTransformer(in_features=230, num_heads=4, ln=False),
            STGCN(in_features=230, num_heads=4, ln=False)
        ]
        ...
        mat_fold = loadmat('data/fold_animal/' + str(trial_i) + '/index' + str(fold_j) + '.mat')  # load mat-file
    ...
    df_concat.to_csv('accuracy_' + data_name + '_set_transformer_r_' + str(r) + '.csv', index=False)
